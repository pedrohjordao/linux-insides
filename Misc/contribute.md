...
As you already may know, I've started a series of [blog posts](http://0xax.github.io/categories/assembly/) about assembler programming for `x86_64` architecture in the last year. I had never written one line of low-level code before this moment, (except a couple of toy `Hello World` examples in the university). It was a long time ago and as I already said, I didn't write low-level code at all. Some time ago I became interested in such things. I understood that I could write programs, but actually didn't understand how my program were arranged.
